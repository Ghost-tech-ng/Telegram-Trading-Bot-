...
# In-memory storage (consider using SQLite for production)
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            WAITING_NAME: [
                CallbackQueryHandler(start_registration, pattern='^start_registrationawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(cancel_operation, pattern='^cancelawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
            ...
            MAIN_MENU: [
                CallbackQueryHandler(show_main_menu, pattern='^proceed_to_menuawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(back_to_menu, pattern='^back_to_menuawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(refresh_balance, pattern='^refresh_balanceawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(visit_website, pattern='^visit_websiteawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(handle_deposit, pattern='^depositawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(show_crypto_options, pattern='^deposit_cryptoawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(payment_made, pattern='^payment_madeawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(handle_withdrawal, pattern='^withdrawawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(withdraw_crypto_amount, pattern='^withdraw_cryptoawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(withdraw_bank_amount, pattern='^withdraw_bankawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(show_copy_trade, pattern='^copy_tradeawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
async def update_profit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        await update.message.reply_text(f"✅ Added ${amount:.2f} profit for user {user_id}.")
                ...
                CallbackQueryHandler(handle_stake, pattern='^stakeawait update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
...
if __name__ == '__main__':
    main()await update.message.reply_text("❌ Invalid format. Usage: /approve <user_id> <amount>")
