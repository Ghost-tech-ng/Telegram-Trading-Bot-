    ...
    try:
        await context.bot.send_message(
            ...
            text=admin_message,),
                ...
                CallbackQueryHandler(handle_admin_action, pattern='^approve_user_'),
            ],
            DEPOSIT_AMOUNT: [
